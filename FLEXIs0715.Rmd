...
#RBP top20 in allFLEX, by number
pdf("Figures/RBP_top20_4cell_log.pdf",height=6,width=12)
Fun<-RBP[,c(1,46:49)]
Fun<-Fun[order(Fun$Cells,decreasing = T),]
barplot(Fun$Cells[Fun$Cells>=30],ylim=c(1,10000),log="y",
        names.arg =Fun$RBP.name[Fun$Cells>=30],las=2)
dev.off()

pdf("Figures/RBP_top20_4cell_linear.pdf",height=6,width=12)
Fun<-RBP[,c(1,46:49)]
Fun<-Fun[order(Fun$Cells,decreasing = T),]
barplot(Fun$Cells[Fun$Cells>=30],ylim=c(0,2000),
        names.arg =Fun$RBP.name[Fun$Cells>=30],las=2)
dev.off()
